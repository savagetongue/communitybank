                  ...
                  <TableCell>
                    {dispute.status === 'OPEN' ? (
                      <div className="flex gap-2">
                        <Button size="sm" onClick={() => handleResolve(dispute.id, 'RESOLVED')}>Resolve</Button>
                        <Button size="sm" variant="outline" onClick={() => handleResolve(dispute.id, 'REJECTED')}>Reject</Button>
                      </div>
                    ) : (
